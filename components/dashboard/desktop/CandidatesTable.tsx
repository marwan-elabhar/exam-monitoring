        ...
        <div className="flex flex-col flex-1 min-h-0">
            ...
            {isLoading ? (
                ...
                <div
                    ...
                    className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden will-change-scroll focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-action-primary focus-visible:ring-inset"
                >
