        ...
        <div className="flex flex-col flex-1 min-h-0">
            ...
            {isLoading ? (
                ...
                <div
                    ...
                    // overflow-y-auto + flex-1 + min-h-0 on parent = bounded scroll container
                    // The virtualizer measures this element's height to calculate visible rows
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        right: 0,
                                        height: ROW_HEIGHT,
                                        // translateY instead of top prevents layout thrashing
